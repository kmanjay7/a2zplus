                            ...
                            <div class="col-lg-8 col-md-8 col-8">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col"> 
                                        ...
                                        <input id="datepicker" onchange="putintodate(this.value)" class="form-control date-font" placeholder="Start Date" type="text" name="start_date">
                                        </div>
                                    </div>
...
function CreateHiddenTable(ListOfMessages)
{
    ...
    TableMarkUp+='<thead><tr><th>Sr. No.</th><th>Order Id</th><th>Order date and time</th><th>Debit User(Name)</th><th>Debit User(User ID)</th><th>Debit User(User Type)</th><th>Credit User(Name)</th><th>Credit User(User ID)</th><th>Credit User(User Type)</th><th>Payment Type</th><th>Transaction Type</th><th>Amount</th><th>Old Balance</th><th>New Balance</th><th>Remarks</th></tr></thead>';
    TableMarkUp+="<tbody>";
    ...
    CreateHiddenTable(Messages);
        ...
        if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
            if (window.navigator.msSaveBlob) {
                ...
                navigator.msSaveBlob(blob, 'DebitReport.xls');
            }
        } else { 
          $('#testAnchor')[0].click()
        }
...
$($("#testAnchor")[0]).click(function(){ 
      $('#testAnchor').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
            $('#testAnchor').attr('download', 'DebitReport.xls');
});
