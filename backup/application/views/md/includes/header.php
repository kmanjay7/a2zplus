      ...
      <div class="container">
         <div class="row">
            <div class="col-md-2 col-lg-2 col-2">
                <a href="<?= ADMINURL.'md/dashboard';?>"> <img src="<?= ADMINURL;?>assets/images/logo.png" style="width:90%;padding:12px 0px;"></a>
            </div>
...
$wallet_Array['user_type'] = getloggeduserdata('user_type'); ?>
                ...
                <span style="font-size: 11px; font-style: italic;">Master Distributor </span>
                </p>
                </div>  
                <div class="col-lg-1">
                ...
                <a href="<?=ADMINURL.'md/profile';?>"> Profile </a>
                <a href="<?=ADMINURL.'md/update_kyc?id='.md5($this->session->userdata('id'));?>"> Update Kyc </a>
                <a href="<?=ADMINURL.'md/reset_pass';?>"> Reset password </a>
                <a href="<?=ADMINURL.'md/Subscribe_plan';?>"> Subscribe </a>
   ...
   <div style="width: 100%" class="bg-footer shadow menu-fix">
      <div class="container mobile-bg ">
                  ...
                  <nav class="navbar navbar-light navbar-expand-lg mainmenu">
                     ...
                     <div class="collapse navbar-collapse" id="navbarSupportedContent">
                       ...
                       <ul class="navbar-nav mr-auto">
                           <li><a href="<?= ADMINURL.'md/dashboard' ?>">Dashboard <span class="sr-only">(current)</span></a></li>
                           ...
                           <li class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a href="<?=ADMINURL.'md/Wallet_ladger_report';?>">Wallet Ledger Report</a></li> 
                                  <li><a href="<?=ADMINURL.'md/credit_report';?>">Credit Report</a></li> 
                                  <li><a href="<?=ADMINURL.'md/debit_report';?>">Debit Report</a></li>
                                  <li><a href="<?=ADMINURL.'md/Add_fund_online_report';?>">Online Fund Report</a></li> 
                              </ul>
                           </li>
                           ...
                           <li class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                 <li><a href="<?=ADMINURL.'md/contact';?>">Contacts</a></li> 
                                 <li><a href="<?=ADMINURL.'md/complaints/manual';?>">My Complaints</a></li>
                                 <li><a href="<?=ADMINURL.'md/Money_transaction_report';?>">My Tickets</a></li>  
                              </ul>
                           </li>
                           ...
                           <li class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                 ...
                                 <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                       <li><a href="<?=ADMINURL.'md/ad';?>">Add</a></li>
                                       <li><a href="<?=ADMINURL.'md/ad/view';?>">View</a></li>
                                    </ul>
                                 </li>
                                  <li class="dropdown">
                                    <a class="dropdown-toggle" href="#" id="navbarDropdown"
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                       <li><a href="<?=ADMINURL.'md/agent';?>">Add</a></li>
                                       <li><a href="<?=ADMINURL.'md/Agent/view';?>">View</a></li>
                                    </ul>
                                 </li>
                                 <li><a href="<?= ADMINURL;?>md/credit_amount">Credit</a></li>
                                 <li><a href="<?= ADMINURL;?>md/debit_amount">Debit</a></li>
                              </ul>
                           </li>
          <li class="dropdown">
        <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button"
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        <li><a href="<?= ADMINURL.'md/add_fund';?>">Add Fund Online </a></li>
        <li><a href="javascript:void(0)">Add Fund Offline </a></li> 
        </ul>
     </li> 
                           <li> <a href="<?= ADMINURL;?>md/downloads"> Downloads </a></li>
