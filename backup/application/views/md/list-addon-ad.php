                  ...
                  <div class="report-area-t">
                     <div class="row">
                        <div class="col-lg-9 col-md-9 col-6 ">
                           ...
                           <h2 style="margin-bottom: 19px;">  DOWNLINE AD <?= $parentdetail['ownername'].' | '.$parentdetail['uniqueid'].' | '.$parentdetail['user_type']?></h2>
                           </div>
                        </div>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                      <td><?= $n;?></td>
                                       ...
                                       <td>
                                        <a href="<?=ADMINURL.'md/update_kyc?id='.md5($mduserval['id']);?>">  <button  class="edit-kyc"> Edit KYC </button></a>
                                       ...
                                       <td>
                                          <a target="_blank" href="<?=ADMINURL.'md/addon_ag_list/view/'.md5($mduserval['id']);?>">   <p class="text-center"> <span class="down-line-agent"><?= $countag;?></span></p></a>
                                       </td>
                                       <td> <a href="<?= ADMINURL.'md/ad?page=1&parentid='.$parentid.'&id='.md5($mduserval['id']);?>"> <button class="update-btn"> Update </button> </a>
