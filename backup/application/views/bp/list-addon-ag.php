                             ...
                             <table class="table">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <a href="<?=ADMINURL.'bp/update_kyc?id='.md5($aguserval['id']);?>"><button class="edit-kyc"> Edit KYC </button></a>
                                       ...
                                       <td> <a href="<?= ADMINURL.'bp/agent?page=1&parentid='.$parentid.'&id='.md5($aguserval['id']);?>"> <button class="update-btn"> Update </button> </a> <button class="delete">Delete</button> </td>
                                    </tr>
                                <?php $n++; }} ?>
