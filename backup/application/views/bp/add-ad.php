    ...
    $('#mobile').on('keyup',function(){
        ...
        if(mobile){
            $.ajax({
                ...
                data:'mobile='+mobile+'&user_type=AD',
                success:function(data){
                    if(data == '1'){
      ...
      <div class="container">
         <section class="cash-area">
            <div class="cash-payment">
               ...
               <form action="<?=ADMINURL.'bp/Ad/save?page='.$page.'&parentid='.$parentid.'&id='.$id?>" onsubmit="return(regvalidate())" method="post">
                     ...
                     <div class="row">
                         <div class="col-lg-4 col-md-4 col-4">
                           ...
                           <select id="parenttype" name="parentytpe" class="form-control">
                              ...
                              <option value="BP" <?php if($parenttype == 'BP'){echo 'selected';}?>> BP </option>
                              <option value="MD" <?php if($parenttype == 'MD'){echo 'selected';}?>> MD </option> 
                           </select>
                        </div>
                        <div class="col-lg-4 col-md-4 col-4">
                        ...
                        <div class="col-lg-4 col-md-4 col-4">
                           ...
                           <input class="form-control lettersOnly" id="firmname" placeholder="Enter Firm Name" type="text" name="firmname" value="<?= $firmname;?>" onkeyup="utp('firmname')" />
                        </div>
                        <div class="col-lg-4 col-md-4 col-4">
                           <label> PAN Card </label>
                           <input class="form-control alphanimericOnly" id="pancard" placeholder="Enter Pan Card" type="text" name="pancard" maxlength="10" value="<?= $pancard;?>" onkeyup="utp('pancard')" />
                        </div>
                        <div class="col-lg-4 col-md-4 col-4">
