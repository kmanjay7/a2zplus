      ...
      <div class="container">
         <div class="row">
            <div class="col-md-2 col-lg-2 col-2">
                <a href="<?= ADMINURL.'ad/dashboard' ?>"> <img src="<?= ADMINURL;?>assets/images/logo.png" style="width:90%;padding:12px 0px;"></a>
            </div>
...
$wallet_Array['user_type'] = getloggeduserdata('user_type'); ?>
                ...
                <span style="font-size: 11px; font-style: italic;">Area Distributor </span>
                </p>
                </div> 
                <div class="col-lg-1">
                ...
                <a href="<?=ADMINURL.'ad/profile';?>"> Profile </a>
                <a href="<?=ADMINURL.'ad/update_kyc?id='.md5($lg_id);?>"> Update Kyc </a>
                <a href="<?=ADMINURL.'ad/reset_pass';?>"> Reset password </a>
                <a href="<?=ADMINURL.'ad/Subscribe_plan';?>"> Subscribe </a>
                  ...
                  <nav class="navbar navbar-light navbar-expand-lg mainmenu">
                     ...
                     <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      <ul class="navbar-nav mr-auto">
                           <li><a href="<?= ADMINURL.'ad/dashboard' ?>">Dashboard <span class="sr-only">(current)</span></a></li>
                           ...
                           <li class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                 <li><a href="<?=ADMINURL.'ad/Wallet_ladger_report';?>">Wallet Ledger Report</a></li>
                                  <li><a href="<?=ADMINURL.'ad/credit_report';?>">Credit Report</a></li> 
                                  <li><a href="<?=ADMINURL.'ad/debit_report';?>">Debit Report</a></li> 
                                  <li><a href="<?=ADMINURL.'ad/Add_fund_online_report';?>">Online Fund Report</a></li>
                              </ul>
                           </li>
                           ...
                           <li class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                 <li><a href="<?=ADMINURL.'ad/contact';?>">Contacts</a></li> 
                                 <li><a href="<?=ADMINURL.'ad/complaints/manual';?>">My Complaints</a></li>
                           ...
                           <li class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdown"> 
                                  ...
                                  <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                      <li><a href="<?=ADMINURL.'ad/agent';?>">Add</a></li>
                                       <li><a href="<?=ADMINURL.'ad/Agent/view';?>">View</a></li>
                                    </ul>
                                 </li>
                                 <li><a href="<?= ADMINURL;?>ad/credit_amount">Credit</a></li>
                                 <li><a href="<?= ADMINURL;?>ad/debit_amount">Debit</a></li>
                              </ul>
                           </li>
    <li class="dropdown">
        <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button"
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        <li><a href="<?= ADMINURL.'ad/add_fund';?>">Add Fund Online </a></li>
        <li><a href="javascript:void(0)">Add Fund Offline </a></li> 
        </ul>
     </li> 
                           <li> <a href="<?= ADMINURL;?>ad/Downloads"> Downloads </a></li>
