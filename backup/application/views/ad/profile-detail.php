            ...
            <section class="cash-area ">
               <div class="cash-payment ">
                  ...
                  <div class="filter-area add-ad-form edit-profile">
                      <form action="<?=ADMINURL.'ad/Profile/saveupdate';?>" method="post"> 
                  <div class="row">
                     ...
                     <div class="col-lg-6 col-md-6 col-6">
                      ...
                      <div class="col-lg-6 col-md-6 col-6">
                        ...
                        <input class="form-control" placeholder="Enter Pan Card" maxlength="10" type="text" value="<?= $userd['pancard'];?>" name="pan_card"  onkeyup="uc('pancard')" id="pancard">
                     </div>
                      <div class="col-lg-6 col-md-6 col-6">
                        <label> Aadhar  No. </label>
                        <input class="form-control numbersOnly" placeholder="Enter Aadhar  No" maxlength="12" type="text" value="<?= $userd['aadharno'];?>" name="adhar_card">
                     </div>
                      <div class="col-lg-6 col-md-6 col-6">
                        <label> Mobile Number </label>
                        <input class="form-control numbersOnly" placeholder="Mobile Number" readonly="" maxlength="10" type="text" value="<?= $userd['mobileno'];?>" name="mobileno">
                     </div>
                     <div class="col-lg-6 col-md-6 col-6">
                        <label> Alternate Number </label>
                        <input class="form-control numbersOnly" placeholder="Alternate Number" maxlength="10" type="text" value="<?= $userd['alt_mobileno'];?>" name="al_number">
                     </div>
                     <div class="col-lg-6 col-md-6 col-6">
                        <label> Email </label>
                        <input class="form-control" placeholder="info@domain.com" type="text" value="<?= $userd['emailid'];?>" name="email">
                     </div>
                     ...
                     <div class="col-lg-6 col-md-6 col-6">
                        ...
                        <input class="form-control numbersOnly" placeholder="Enter Pin Code" type="text" value="<?= $userd['pincode'];?>" name="pin_code" maxlength="6"  />
                     </div>

                     <div class="col-lg-12 col-md-12 col-12">
                           <label> Address </label>
                           <textarea name="address" class="text_area_c" id="address" cols="30" onkeyup="uc('address');" rows="3"><?= $userd['address'];?></textarea>
                        </div>
                        <div class="col-lg-12 col-md-12 col-12">
                           <label> Outlet Address </label>
                           <textarea name="outletaddress" class="text_area_c" id="outletaddress" cols="30" onkeyup="uc('outletaddress');" rows="3"><?= $userd['outletaddress'];?></textarea>
                        </div>
                  </div>
                  ...
                  <div class="row">
                     ...
                     <div class=" offset-md-7 col-lg-5 col-md-5 col-5">
                        <div class="btn-create">
                           ...
                           <button style="pointer-events: <?=$kyc_status=='yes'?'none':'all'?>;" type="submit" value="" class="chang-button hvr-shutter-out-horizontal"> Update Profile</button>
