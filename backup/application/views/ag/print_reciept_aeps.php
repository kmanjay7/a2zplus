    ...
    <div style="display: block; margin: auto; margin-top: 41px; width: 668px">
        ...
        <table style="width:100%; border:2px solid #111" border="1" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td>
                    <img style="width: 176px;" src="<?=ADMINURL.'assets/'?>images/icici_bank.webp" alt="">
                </td>
            </tr>
             ...
             <tr> 
                ...
                <td>
                   <h4 style="color: #000000;font-size: 12px;font-weight: 600;padding: 0px;  margin: 0px;  text-align: center;"> AEPS </h4> 
                    ...
                    <?php if($slipData['mode']=='WAP'){ echo 'CASH WITHDRAWAL';}
                        else if($slipData['mode']=='BAP'){ echo 'BALANCE INQUIRY';}
                        else if($slipData['mode']=='SAP'){ echo 'MINI STATEMENT';}
                    ?> 
                    </h4>  
                </td> 
            </tr>
        ...
        <table style="width:100%; border:2px solid #111" border="1" cellspacing="0" cellpadding="0">
            <tr> 
             ...
             <tr> 
                <td> 
                     <h4 style="color: #000000;font-size: 11px;font-weight: 500;padding:0px;
                    margin: 0px; margin-top: 10px; text-align: center;"> <?=$slipData['bank'];?> 
                     </h4> 
                </td> 
                <td> 
                     <h4 style="color: #000000;font-size: 11px;font-weight: 500;padding:0px;
                 ...
                 <td> 
                     <h4 style="color: #000000;font-size: 11px;font-weight: 500;padding:0px;
                    margin: 0px; margin-top: 10px; text-align: center;"> 
                    <?php $arr = json_decode($slipData['api_response'],true );

                   echo  !empty($arr['data']['balance'])?$arr['data']['balance']:'0.00';?> 
                    </h4>  
                </td>   
            </tr>
...
<?php if($slipData['mode']=='SAP'){
$Statementarr = isset($arr['data']['mini_statement'])?$arr['data']['mini_statement']:[]; 
if(!empty($Statementarr)){
 ?> 

<!-- -----------------  CREATE MINISTATEMENT SCRIPT  START ------------   -->
<div style="width: 668px; float: left; margin-top: 12px">
        <table style="width:100%; border:2px solid #111" border="1" cellspacing="0" cellpadding="0">
            <tr> 
                <td style="width: 100%" colspan="4">
                    <h4 style="color: #000000;font-size: 12px;font-weight: 700;padding: 0px;
                    margin: 0px; text-align: center;"> Statement of Account </h4> 
                </td>  
            </tr>
            ...
            <tr> 
                <td style="width: 25%" >
                    <h4 style="color: #000000;font-size: 12px;font-weight: 700;padding: 0px;
                    margin: 0px; text-align: center;"> Transaction Date </h4> 
                </td>
                <td style="width: 25%" >
                    <h4 style="color: #000000;font-size: 12px;font-weight: 700;padding: 0px;
                    margin: 0px; text-align: center;"> Transaction Type </h4> 
                </td> 
                <td style="width: 25%" >
                    <h4 style="color: #000000;font-size: 12px;font-weight: 700;padding: 0px;
                    margin: 0px; text-align: center;"> Txn Amount </h4> 
                ...
                <td style="width: 25%" >
                    <h4 style="color: #000000;font-size: 12px;font-weight: 700;padding: 0px;
                    margin: 0px; text-align: center;"> Narration </h4> 
                </td>  
            </tr>
            ...
            <tr> 
                <td style="width: 100%" colspan="4">
                   <?php  foreach ($Statementarr as $key => $stvalue) {?> 
                    <div style="width: 100%;float: left; clear: both;">
                    <div style="width: 25%;float: left;"><?=$stvalue['date'];?></div>
                    <div style="width: 25%;float: left;"><?=strtoupper($stvalue['txnType'])=='CR'?'Credit':'Debit';?></div>
                    <div style="width: 25%;float: left;"><?=$stvalue['amount'];?></div>
                    <div style="width: 25%;float: left;"><?=$stvalue['narration'];?></div>
                    </div>  
                    <?php } ?>  
                </td>   
            </tr>
...
<?php } } ?>
<!-- -----------------  CREATE MINISTATEMENT SCRIPT  END ------------   -->
...
<table style="width:100%; border:2px solid #111" border="1" cellspacing="0" cellpadding="0">
    <tr> 
        ...
        <li style="font-size: 12px;font-weight: 500;color: #000;">Customer Convenience Fee (CCF) = Rs. 0.00 inclusive of GST.</li>
