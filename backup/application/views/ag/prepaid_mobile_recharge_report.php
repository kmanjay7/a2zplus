...
<td><a href="<?=ADMINURL.$folder.'/prepaid_reciept?utp='.md5($value['reqid']);?>" target="_blank" > <button id="ap1" class="update-btn w-101"> Print Receipt </button></a>
    ...
    CreateHiddenTable(Messages);
        ...
        if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
            if (window.navigator.msSaveBlob) {
                ...
                navigator.msSaveBlob(blob, 'PrepaidMobileRechargeReport.xls');
            }
        } else { 
          $('#testAnchor')[0].click()
        }
...
$($("#testAnchor")[0]).click(function(){ 
      ...
      $('#testAnchor').attr('download', 'PrepaidMobileRechargeReport.xls');
});
