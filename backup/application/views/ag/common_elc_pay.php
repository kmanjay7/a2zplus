          ...
          <div class="col-md-10 col-lg-10 col-12" style="float: left;">
                   ...
                   <!--  <div class="row m-15" id="dynamic_fields" ></div>  -->
                    <div class="row">
                     ...
                     <input required="" class="form-control" onblur="setAccountId()" placeholder="Consumer Number" type="text" id="accountIdHdMain" name="number" autocomplete="off">
                  ...
                  <div class="col-md-12 col-lg-12 col-12" id="col-checkbill" style=""> 
                     <button type="button" class="form-control apply-filter w-100" id="checkbill" style="background: #4f9d38; margin-top: 31px;" onclick="fetch();"> Go </button>
                  </div>
                  </div>
...
<?php if($pagename=='electricity_payment'){ ?>
   function pay()
   {
     operator=$("#operator").val();
     mobile_no=$("#mobile_no").val();
 ...
 <?php if($pagename=='electricity_bill'){ ?>
      function pay()
     {
       operator=$("#operator").val();
       mobile_no=$("#mobile_no").val();
