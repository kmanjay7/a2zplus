      ...
      <div class="row"> 
         ...
         <div class="col-lg-8">
            <div style="width: 100%; margin-top: 30px">
               <input type="hidden" name="port" id="captureport" value="11101" >
               ...
               <form action="#" id="dataSubmit">
                ...
                <input type="hidden" value="0" name="srno" id="srno">
                  ...
                  <div class="row"> 
                     ...
                     <select name="sp_key" id="sp_key" class="form-control select2" onchange="disAmount(this.value);">
                  ...
                  <div class="row" style="margin-top:20px"> 
                     ...
                     <div class="col-12 col-md-6 col-lg-6">  
                     <input  type="text" name="aadhaar_uid" id="aadhaar_uid" placeholder="Enter Aadhaaar Number" maxlength="12" onkeyup="this.value = this.value.replace(/[^0-9\.]/g,''),checkAadhar(this.value);" onblur="checkAadhar(this.value);" class="form-control " value="" autocomplete="off"> 
                     </div>  
...
document.getElementById("thumbnail").src = "<?=ADMINURL.'assets/images/ICN_scan_fp.gif'?>";
  ...
  function maketransaction(id,typedata){ 
    ...
    aadhaar_uid = aadhaar_uid.split('-').join('');
    ...
    if(sp_key == ''){ swalpopup('error','Select cash widthdraw/balance enquiry!'); 
    ...
    }else if( (aadhaar_uid.length != 12 || !validateAadhaar(aadhaar_uid)) ){
      swalpopup('error','Please enter 12 digit valid aadhaar number!'); return false;
      ...
      swalpopup('error','Please Allow Geolocation!');
      return false;
    }else if(long == 0 ){
      swalpopup('error','Please Allow Geolocation!');
      return false;
    ...
    $.ajax({
                type:'POST',
                url:'<?=base_url('ag/aeps/post_formdata');?>',
                data:formData,
                chache:false,
                dataType : 'html',
                beforeSend:function(){ 
...
function checkAadhar(uid){ 
    $('#aadhaar_uid').css({'border-color':'#c9c7c7'}); 
    var aadhaar = uid.split('-').join('');
     if( (aadhaar.length == 12 && !validateAadhaar(aadhaar) ) ){
      $('#aadhaar_uid').css({'border-color':'red'});
      $("#aadhaar_uid" ).focus();
      swalpopup('error','Aadhar Number is Wrong!');
     }
}
</script>
...
<script type="text/javascript" src="<?=ADMINURL.'assets/js/aadhaar.js';?>"></script>
</body>
