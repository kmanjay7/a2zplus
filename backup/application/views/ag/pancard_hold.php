...
?>
          ...
          <tr id="hd<?=$value['id'];?>">
              ...
              <td>
              <p class="<?=statusbtn_c('PENDING','class');?>"> <span></span> Hold </p><p><?php echo $value['holdon'] ;?></p>
              </td>


      
  <td>    
     <center><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?=$value['remark'];?>" >Remark </a></center>
<br/> 
       <a href="<?=$uploaduri;?>" > <button id="ap1" class="update-btn ap_bg "> Upload </button> </a> 
