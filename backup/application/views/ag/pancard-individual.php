...
<div class="row m-15"> 
    ...
    <div class="col-md-3 col-lg-3 col-12">
       <div class="form-group">
          ...
          <?= form_dropdown(array('name'=>'applicant_type','id'=>'applicant_type', 'class'=>'form-control select2'),array('1'=>'Individual'),set_value('applicant_type',$applicant_type));?> 
       </div> 
    </div>
...
$("#gender option[value=" + arg + "]").prop("selected",true);
}
...
function checkEmail(str)
{
    ...
    if(!re.test(str)){
       swalpopup('error','Please enter valid email id');
       //$('#email').focus();
    }
