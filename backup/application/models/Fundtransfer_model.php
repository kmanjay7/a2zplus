...
class Fundtransfer_model extends CI_Model{
	...
	public function countitem_fnd($table,$where = null, $whereor = null,$whereorkey = null ){
...
public function getSingle_fnd( $table,$where = null,$keys = null , $orderby = null,$limit = null,$inkey=null,$invalue=null,$not_inkey=null,$not_invalue = null ){
		if(!is_null($keys)){
		$keys = trim($keys);
		$this->db->select($keys);
		}
...
public function saveupdate_fnd($table, $dataarray, $validation = null, $where = null, $id = null ){
