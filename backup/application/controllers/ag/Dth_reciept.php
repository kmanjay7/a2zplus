...
class Dth_reciept extends CI_Controller{
...
public function index(){ 
        ...
        $data['title'] = 'DTH Recharge Receipt';
        $data['folder'] = 'ag/'; 
...
<td width="25%" >
<center><img style="width: 80px; margin-top: 0px;" src="'.ADMINURL.'assets/images/'.$slipData['image'].'" alt=""></center>
</td>
</tr>
...
<h4 style="color: #000000;font-size: 12px;font-weight: 700;padding: 0px;
margin: 0px; text-align: center;"> Customer ID </h4> 
</td> 
<td style="width: 25%;border-right:1px solid #111;border-bottom:1px solid #111">
<h4 style="color: #000000;font-size: 12px;font-weight: 700;padding: 0px;
