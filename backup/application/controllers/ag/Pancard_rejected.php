...
class Pancard_rejected extends CI_Controller{
  var $panename; 
  var $foldername; 
  var $attemptstatus; 
  public function __construct(){ 
    parent::__construct();     
               ...
               agsession_check();
               sessionunique();  
               $this->pagename = 'pancard_rejected';
               $this->foldername = 'ag';
               $this->attemptstatus = 'reject';
    }
    ...
    public function index(){ 
        ...
        $data['title'] = 'All Rejected Pan Card'; 
