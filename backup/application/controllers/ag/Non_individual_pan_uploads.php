...
class Non_individual_pan_uploads extends CI_Controller{
	  var $folder;
    var $pagename;
	public function __construct(){
        ...
        $this->load->library('session'); 
               ...
               $this->load->helper('security');
                agsession_check();
                $this->folder = 'ag';
                $this->pagename = 'Non_individual_pan_uploads';
	...
	public function index(){ 
            ...
            $data['pagename'] = $this->pagename;
               ...
               agview('non_individual_pan_uploads',$data); 
...
public function upload(){
       ...
       if( $post['filename'] == 'appforma' ){
            $documenttype = 'Application Form (Part 1)';
            $compress = true;
       }else if( $post['filename'] == 'appformb' ){
            $documenttype = 'Application Form (Part 2)'; 
            $compress = true;  
