...
class Individual_pan_corr_uploads extends CI_Controller{
	  var $folder;
    var $pagename;
	public function __construct(){
        ...
        $this->load->library('session'); 
               ...
               $this->load->helper('security');
                agsession_check();
                $this->folder = 'ag';
                $this->pagename = 'Individual_pan_corr_uploads';
	...
	public function index(){ 
            ...
            $data['pagename'] = $this->pagename;
               ...
               agview('individual_pan_corr_uploads',$data); 
...
public function upload(){
       ...
       if( $post['filename'] == 'appform' ){
            $documenttype = 'Application Form';
       }else if( $post['filename'] == 'aadharimg' ){
