        ...
        if($res["status"])
        {
            ...
            {   
                ...
                if(!empty($field["values"]))
                {
                    ...
                    {
                        $html.='<div class="col-md-3 col-lg-4 col-12">';
                        $html.='<label> '.$field["values"]["groupingKeys"][0].' </label>';
                        $html.='<Select onchange="hide_pay_btn()" required="" class="form-control select2" placeholder="'.$field["values"]["groupingKeys"][0].'" type="text" name="'.$field["values"]["groupingKeys"][0].'">';
