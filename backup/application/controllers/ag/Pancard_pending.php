...
class Pancard_pending extends CI_Controller{
  var $panename; 
  var $foldername; 
  var $attemptstatus; 
  public function __construct(){ 
    parent::__construct();     
               ...
               agsession_check();
               sessionunique();  
               $this->pagename = 'pancard_pending';
               $this->foldername = 'ag';
               $this->attemptstatus = 'new';
    }
    ...
    public function index(){ 
        ...
        $data['title'] = 'All Pending Pan Card'; 
