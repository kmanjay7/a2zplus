...
class Money_transaction_report extends CI_Controller{
  ...
  public function checkTranStatus(){
        ...
        $select = 'SUM(dt_dmtlog.bp_comi) as commission, SUM(dt_dmtlog.bp_tds) as tds, SUM(dt_dmtlog.amount) AS total, SUM(dt_dmtlog.sur_charge) as surcharge';
 ...
 $urluri = ADMINURL.$this->folder.'/'.$this->pagename.'/index/?';
        ...
        bpview('money_transaction_report',$data );
        }  
