...
class Ad extends CI_Controller{
	...
	public function index($id=false){ 
           ...
           /* check subscription plan start*/
            ...
            redirect( ADMINURL.'md/Subscribe_plan');
            } 
            /* check subscription plan end*/
             ...
             $data['scheme'] = $this->dg_model->getAll('dt_scheme','sch_name ASC',array('status'=>'yes','user_type'=>'AD'));
       ...
       public function save($id=false){
             ...
             $dpcheck = empty($id) ? (['uniqueid'=>$saveup['uniqueid'],'user_type'=>'AD']):null;
...
DigiCash India.';
    ...
    /*send update msg to agent end*/
             ...
             if(!empty($update)){
                    ...
                    redirect(ADMINURL.'md/addon_ad_list/view/'.$parentidx);  
                    }else{
                    $this->session->set_flashdata('success','Done Successfully!!!!');
                    redirect(ADMINURL.'md/ad/view');      
                    }
             }else{
