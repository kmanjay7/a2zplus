...
class Agent extends CI_Controller{
	...
	public function index($id=false){
            ...
            redirect( ADMINURL.'ad/Subscribe_plan');
            } 
     ...
     public function view($page=false){ 
                ...
                $start = $page;
                $limit = 10;
                $base_url = (ADMINURL.'ad/Agent/view/');
        ...
        public function save($id=false){
             ...
             $parentid = $this->dg_model->getSingle('users',array('uniqueid'=>$pdata['parentid'],'user_type'=>$pdata['parentytpe']),'id');
...
/*send update msg to agent end*/
            ...
            $update = $this->dg_model->saveupdate('dt_users', $dataaa, NULL, array('id'=>$lid));
                ...
                redirect(ADMINURL.'ad/Addon_ag_list/view/'.$parentidx);  
                }else{
                $this->session->set_flashdata('success','Data Submitted Successfully!!!!');
                redirect(ADMINURL.'ad/agent/view');      
                }
            }else{
