...
class Web_hook_goldpay extends CI_Controller{
...
$Merchantrefno = isset($post['rchid'])?$post['rchid']:false;
$Status = isset($post['Status'])? $obj->goldpay_status($post['Status']):false;
$TransactionID = isset($post['Operatorid'])?$post['Operatorid']:false;
$apiorderID = ''; 
