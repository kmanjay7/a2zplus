...
$datas = array( 
            ...
            'transactionId' => $Merchantrefno,
        );
        

$header =['accept'=>'application/json','Apitoken'=>DIGIUPAY_APITOKEN,'cache-control'=>'no-cache'];
$responses =curlApis(DIGIUPAY_URL.'transaction-status','POST',$datas,$header,50);

$bbps_response = $responses;
...
$TransactionID = isset($bbps_response->LiveId)?$bbps_response->LiveId:false;
$apiorderID = '';
...
if($Merchantrefno && $Statuss){ 
    ...
    $serviceid = (int)$orderinfo['serviceid'];
        ...
        if($serviceid == 5){
          ...
          $servicename = 'DIGIUPAY Electricity';
          $servicename2 = 'digiupay_elc';
        }
